    ...
    messages: [
      {
        ...
        content: stripIndents`
            ...
            Select which objects should be picked up. Respond with a JSON object
            which has a single field, "selectedObjects", which is an array
            of object IDs to be picked up.
            If the user prompts you for something unrelated to picking up objects,
            the array should be empty. If the user asks for something that is not
            in the list of objects, set "selectedObjects" to null.
          `
      },
      {
        role: 'user',
